    ...
    return (
      <CurrentWeather>
            ...
            <div className="new-city">
              ...
              <span>
                <i
                  onClick={() =>
                    this.input.value !== "" &&
                    this.props.getWeather(this.input.value)
                  }
        ...
        <div className="temperature">
          <div>
          <img src={weatherIcon(this.props.currentDay[0].weather[0].id, new Date().getHours())} alt={this.props.currentDay[0].weather[0].main}/>
          </div>
